...
static const uint8_t wasd_keys[] = {HID_KEYBOARD_W, HID_KEYBOARD_A, HID_KEYBOARD_S, HID_KEYBOARD_D};
...
int32_t mousejiggler_app(void* p) {
    ...
    // Create timer
    FuriTimer* timer = furi_timer_alloc(mousejiggler_timer_cb, FuriTimerTypePeriodic, event_queue);
